    ...
    <section id="about-section">
      <div className="about">
        ...
        <div className="about-container">
          <p>
            Ayant un parcours qui combine la rigueur et la patience acquises
            dans la pâtisserie, ainsi que le sens des priorités et la pédagogie
            de mon expérience en enseignement, me permet aujourd'hui de
            concevoir des projets web avec méthode et créativité, en apportant
            des solutions innovantes et de qualité. Mon objectif est de
            continuer à fusionner mes différentes passions et compétences dans
